...
public class declareSuccessService implements JavaDelegate {
    @Override
    public void execute(DelegateExecution execution) throws Exception {
        System.out.println("海关成功收到申报信息");
...
//        runtimeService.correlateMessage("Message_delaration_received");
        ...
        for (String url : endpointUrls) {
            try {
                SendTask.sendPostRequest(url, "Message_declare_success_received", businessKey);
